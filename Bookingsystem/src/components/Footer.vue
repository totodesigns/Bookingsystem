    ...
    <footer class="content-block">
        ...
        <div class="footer-columns">
            <div class="text-gap-l">
                <p class="t1">Kontakt</p>
                <div class="text-gap-xs">
                    <p class="t2">Adresse</p>
                    <p>Herluf Trolles Vej 116A</p>
                    <p>5220 Odense SØ</p>
                </div>
                <div class="text-gap-xs">
                    <p class="t2">Allan Frederiksen</p>
                    <p>allan@strong4life.dk</p>
                    <p>28 93 97 80</p>
                </div>
                <div class="text-gap-xs">
                    <p class="t2">Ole Stougaard</p>
                    <p>ole@strong4life.dk</p>
                    <p>51 94 24 06</p>
                </div>
            </div>
            <div class="text-gap-l">
                <p class="t1">Navigation</p>
                <div class="text-gap-xs">
                    <a href="medlemskaber">Medlemskaber</a>
                    <a href="personligtraening">Personlig træning</a>
                    <a href="holdtraening">Holdtræning</a>
                    <a href="traeningsforloeb">Træningsforløb</a>
                    <a href="sponsor">Sponsorfællesskab</a>
                    <a href="moeder">Møder og træning</a>
                    <a href="#">Om os</a>
                    <a href="kontakt">Kontakt</a>
                </div>
            </div>
            <div class="text-gap-l">
                <p class="t1">Åbningstider</p>
                <div class="text-gap-xs">
                    <p class="t2">Hverdage</p>
                    <p>mandag - fredag</p>
                    <p>06:00 - 24:00</p>
                </div>
                <div class="text-gap-xs">
                    <p class="t2">Weekender</p>
                    <p>lørdag - søndag</p>
                    <p>06:00 - 24:00</p>
                </div>
            </div>
        ...
        <div class="footer-info">
            <div class="text-gap-s">
                <p class="caption">(c) Strong4life</p>
                <p class="caption">CVR: 37 62 63 92</p>
            </div>
